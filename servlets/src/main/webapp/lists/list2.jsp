    ...
    <script>
        ...
        function setup() {
            ...
            var socket = new MyWebSocket(
                    "<%=((Printable)request.getAttribute("list")).getResponseElementName()%>",
                ...
                <tr>
                    <td valign="top" width="200px" style="border:#0000FF solid 1px" height=300px>
                        <div class="left_menu_my">
                            <ul>
                                ...
                                <li><a href="#" onclick="messageList.">Сообщения</a><a color="red" href=#></a></li>
                    ...
                    <td margin=0px valign=top style="border:#0000FF solid 1px" height=300px>
                        <table width=100% margin=0px>
                            <tr>
                                <td valign="top" id="response_element">
                                  <!--  <div class="prokrutka" id="response_element" height="100%">
